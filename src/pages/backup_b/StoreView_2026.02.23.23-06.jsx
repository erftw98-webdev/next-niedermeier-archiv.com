...
function StoreView() {
  ...
  const infoTexts = {
    ...
    teilen: `Klick hier, du siehst im unteren Teil dieser Seite **alle Teile** von **${currentImage.title}**. Außerdem siehst du die freien und reservierten Teile.`,
  ...
  return (
    <div className="store-page">
      <div className="store-upper-section">
        ...
        {/* RECHTS: Titel, Zweispaltige Liste & Buttons */}
          ...
          <div className="brand-nav-row">
            ...
            <div className="brand-right">
              <button 
                ...
                onClick={() => window.open(`/liste/${currentImage.id}`, '_blank')}
              >
                LISTE
              </button>
      ...
      {/* NEU: Das Info-Icon mittig unter den Bildern */}
